...
import { ContainerState, createWebContainerRuntimeState, maxDevServerLogs, releaseWebContainer, setupWebContainer, writeRootFile } from "./webcontainer";
...
export const PreviewFrame:React.FC<PreviewFrameProps> = ({code, onPreviewError, setProgressBarValue, setProgressBarTotal}) => {
    ...
    const [containerState, setContainerState] = useState<ContainerState>(ContainerState.Booting);
